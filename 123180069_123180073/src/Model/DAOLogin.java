...
public class DAOLogin {
    ...
    public DAOLogin() {
        try {
            ...
            String url = "jdbc:mysql://localhost/service_laptop";
    ...
    public boolean login(ModelLogin modelLogin) {
        try {
            String query = "SELECT * FROM pegawai WHERE username = '" + modelLogin.getUsername() + "' " + "AND password = '" + modelLogin.getPassword() + "'";
